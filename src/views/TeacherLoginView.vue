<template>
  <div class="page">
    <div class="container my-5 p-5">
      ...
      <div class="row">
        <div class="col-12">
          <h2 class="text-center">تـسجيل الدخول الأساتذه </h2>
...
const email = ref<string>("hazlaom@elkeber.com");
const password = ref<string>("hazlaom@elkeber.com");
function teacherLogin() {
  auth.teacherLogin(email.value, password.value);
  email.value = "";
  password.value = "";
  router.push("/");
}
